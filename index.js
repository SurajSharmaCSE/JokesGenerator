...
// Function to generate and display a random joke
...
// Run loop to print 10 jokes
for (let i = 1; i <= 10; i++) 
{
    // Construct the ID of the joke container
    let id = 'joke-container' + i; // Adjust index to start from 1
    // Check if i is within the length of the jokes array
    if (num+i <jokes.length) {
        // Display the selected joke in the corresponding container
        document.getElementById(id).textContent = jokes[num+i];
    }
}
}    
// Call the function when the page loads
window.onload = generateRandomJoke;
